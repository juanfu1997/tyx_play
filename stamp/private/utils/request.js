...
//保存一码一贴信息
function SaveUniquecodeInfo(url,userid,subject_id,picture,contentJSON){
	return util.post('/tyxcms/uniquecode.php/save',{ url:'/letter?id=',userid,subject_id,picture,contentJSON:JSON.stringify(contentJSON) })
}
